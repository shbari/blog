...
<div class="blog-container">
  ...
  <div class="search-wrapper">
    <input type="text" id="search-bar" class="search-input" placeholder="Search by article title or keywords..." oninput="executeSearchAndFilter()">
  </div>
  ...
  <div class="tag-container">
    ...
    {% for tag in sorted_tags %}
      <button onclick="selectTag('{{ tag[0] }}', this)" class="tag-btn">#{{ tag[0] }}</button>
    {% endfor %}
  </div>
...
function executeSearchAndFilter() {
  ...
  posts.forEach(post => {
    ...
    const postTags = postTagsAttribute.split(',');
...
// Hover event listeners for modern UI response
